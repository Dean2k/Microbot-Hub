package net.runelite.client.plugins.microbot.shrekfighter.skill;
...
public class AttackStyleScript extends Script {
    ...
    private void scheduledTask(ShrekFighterConfig config) {
        try {
    ...
    private void changeAttackStyle(ShrekFighterConfig config, WidgetInfo attackStyleWidgetInfo) {
    ...
    private void selectSkills(ShrekFighterConfig config) {
    ...
    private WidgetInfo getComponentToDisplay(ShrekFighterConfig config) {
