...
import net.runelite.client.plugins.microbot.shrekfighter.combat.AttackNpcScript;
import net.runelite.client.plugins.microbot.shrekfighter.model.Monster;
...
import static net.runelite.client.plugins.microbot.shrekfighter.combat.AttackNpcScript.filteredAttackableNpcs;
import static net.runelite.client.plugins.microbot.shrekfighter.combat.FlickerScript.currentMonstersAttackingUsRef;
import static net.runelite.client.ui.overlay.OverlayUtil.renderPolygon;

public class ShrekFighterOverlay extends OverlayPanel {
    ...
    @Inject
    private ShrekFighterOverlay(ModelOutlineRenderer modelOutlineRenderer, ShrekFighterConfig config) {
