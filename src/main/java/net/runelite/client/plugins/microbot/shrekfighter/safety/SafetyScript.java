package net.runelite.client.plugins.microbot.shrekfighter.safety;
...
public class SafetyScript extends Script {
    ...
    public void stopAndLog(String reason) {
        ...
        Rs2Player.logout();
        Plugin PlayerAssistPlugin = Microbot.getPlugin(ShrekFighterPlugin.class.getName());
        Microbot.stopPlugin(PlayerAssistPlugin);
    }

    private boolean isBankingOrWalking() {
        State state = ShrekFighterPlugin.getState();
