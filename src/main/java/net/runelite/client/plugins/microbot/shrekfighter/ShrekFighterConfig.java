...
public interface ShrekFighterConfig extends Config {
    ...
    @ConfigItem(
            keyName = "ReequipArrows",
            name = "Re-equip looted arrows",
            description = "Automatically re-equip arrows after looting if they match your currently equipped ammo",
            position = 21,
            section = lootSection
    )
    default boolean toggleReequipArrows() {
        return false;
    }
